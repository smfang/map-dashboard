...
export interface ProjectNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ProjectNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ProjectNFT;
  ...
  mint: TypedContractMethod<[tokenURI: string], [bigint], "payable">;
